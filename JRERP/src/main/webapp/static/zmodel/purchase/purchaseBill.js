function getColumn(){
	return [
	        ...
	        {id:"netGoldWeight",sort:"int",header:"净金重",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"goldLoss",sort:"int",header:"金损"},
	        {id:"goldPurity",sort:"int",header:"金成色"},
	        {id:"goldWeight",sort:"int",header:"金重",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"goldPrice",sort:"int",header:"金价"},
	        {id:"goldMoney",sort:"int",header:"金料额",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"productWeight",sort:"int",header:"货重",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"workFeeKe",sort:"int",header:"克工费"},
	        {id:"workFeeJian",sort:"int",header:"件工费"},
	        {id:"workFeeSum",sort:"int",header:"总工费",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"certificateFee",sort:"int",header:"证书费",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"fittingName",sort:"string",header:"配件名称"},
	        {id:"fittingNum",sort:"string",header:"配件数",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"fittingFee",sort:"int",header:"配件金额",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"sandBlastFee",sort:"int",header:"喷砂镶石费",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"otherFee",sort:"int",header:"其他费用",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"unitPrice",sort:"int",header:"成本单价"},
	        {id:"costPrice",sort:"int",header:"成本金额",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"labelWorkFeeKe",sort:"int",header:"标签克工费"},
	        {id:"labelWorkFeeJian",sort:"int",header:"标签件工费"},
	        {id:"labelWorkFeeSum",sort:"int",header:"标签工费",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"labelRate",sort:"int",header:"加价率"},
	        {id:"labelPrice",sort:"int",header:"标签价",footer:{ content:"summColumn" }},
	        {id:"labelPriceSum",sort:"int",header:"标价金额",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        ...
	        {id:"mJewelNum",sort:"int",header:"主石数",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"mJewelWeight",sort:"int",header:"主石重",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"mJewelPrice",sort:"int",header:"主石价"},
	        {id:"mJewelFee",sort:"int",header:"主石额",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"sJewel1Name",sort:"string",header:"副石1名"},
	        {id:"sJewel1No",sort:"string",header:"副石1石号"},
	        {id:"sJewel1Specifi",sort:"string",header:"副石1规格"},
	        {id:"sJewel1Num",sort:"int",header:"副石1数",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"sJewel1Weight",sort:"int",header:"副石1重",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"sJewel1Price",sort:"int",header:"副石1价"},
	        {id:"sJewel1Fee",sort:"int",header:"副石1额",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"sJewel2Name",sort:"string",header:"副石2名"},
	        {id:"sJewel2No",sort:"string",header:"副石2石号"},
	        {id:"sJewel2Specifi",sort:"string",header:"副石2规格"},
	        {id:"sJewel2Num",sort:"int",header:"副石2数",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"sJewel2Weight",sort:"int",header:"副石2重",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
	        {id:"sJewel2Price",sort:"int",header:"副石2价"},
	        {id:"sJewel2Fee",sort:"int",header:"副石2额",format:webix.i18n.numberFormat,footer:{ content:"summColumn" }},
