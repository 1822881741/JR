function getColumn(){
	return [
     ...
     {id:"outNum",sort:"int",header:["出库数"],footer:{ content:"summColumn" },css:{"color":"red"}},
     {id:"outGoldWeight",sort:"int",header:["出库金重"],footer:{ content:"summColumn" },css:{"color":"red"}},
     {id:"outMJewelWeight",sort:"int",header:["出库石重"],footer:{ content:"summColumn" },css:{"color":"red"}},
     {id:"outCostPrice",sort:"int",header:["出库成本"],footer:{ content:"summColumn" },css:{"color":"red"}},
     {id:"outLabelPriceSum",sort:"int",header:["出库标价金额"],footer:{ content:"summColumn" },css:{"color":"red"}},
