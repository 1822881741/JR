    ...
    return this.each(function () {
      ...
      strategies['default'] = function (iframe, $iframeBody, options) {
        // NOTE: this is how the plugin determines the iframe height, override if you need custom
    	  //
    	  console.log("===============gxh=========$iframeBody[0].scrollHeight + options.heightOffset====="+$iframeBody[0].scrollHeight + options.heightOffset);
    	  console.log("===============gxh=========options.heightOffset====="+options.heightOffset);
