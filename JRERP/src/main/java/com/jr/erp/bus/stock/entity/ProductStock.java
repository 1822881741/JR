...
public class ProductStock extends BaseEntity {
     ...
     * 虚拟成本
     */
    private Double xuNiCostPrice;

    /**
     * 旧饰标记：0不是旧饰品；1：是旧饰
     */
    private Boolean oldOrnamentsFlag;

    /**
     * 原标价
     */
    private Double oldLabelPrice;

    /**
     * 在途数量
     */
    private Integer zaiTuNum;
    ...
    /**
     * 库存时间:使用的是入库单（或调拨单）的时间
     * @return dataTime 库存时间:使用的是入库单（或调拨单）的时间
     */
    ...
    /**
     * 库存时间:使用的是入库单（或调拨单）的时间
     * @param dataTime 库存时间:使用的是入库单（或调拨单）的时间
     */
    ...
    /**
     * 虚拟成本
     * @return xuNiCostPrice 虚拟成本
     */
    public Double getXuNiCostPrice() {
        return xuNiCostPrice;
    }

    /**
     * 虚拟成本
     * @param xuNiCostPrice 虚拟成本
     */
    public void setXuNiCostPrice(Double xuNiCostPrice) {
        this.xuNiCostPrice = xuNiCostPrice;
    }

    /**
     * 旧饰标记：0不是旧饰品；1：是旧饰
     * @return oldOrnamentsFlag 旧饰标记：0不是旧饰品；1：是旧饰
     */
    public Boolean getOldOrnamentsFlag() {
        return oldOrnamentsFlag;
    }

    /**
     * 旧饰标记：0不是旧饰品；1：是旧饰
     * @param oldOrnamentsFlag 旧饰标记：0不是旧饰品；1：是旧饰
     */
    public void setOldOrnamentsFlag(Boolean oldOrnamentsFlag) {
        this.oldOrnamentsFlag = oldOrnamentsFlag;
    }

    /**
     * 原标价
     * @return oldLabelPrice 原标价
     */
    public Double getOldLabelPrice() {
        return oldLabelPrice;
    }

    /**
     * 原标价
     * @param oldLabelPrice 原标价
     */
    public void setOldLabelPrice(Double oldLabelPrice) {
        this.oldLabelPrice = oldLabelPrice;
    }

    /**
     * 在途数量
     * @return zaiTuNum 在途数量
     */
    public Integer getZaiTuNum() {
        return zaiTuNum;
    }
     ...
     * @param zaiTuNum 在途数量
     */
    public void setZaiTuNum(Integer zaiTuNum) {
        this.zaiTuNum = zaiTuNum;
    }

    /**
     * 在途商品已接收数量
     * @return receiveNum 在途商品已接收数量
     */
    ...
    /**
     * 在途商品接收人员ID
     * @return receiveUserId 在途商品接收人员ID
     */
    ...
    /**
     * 在途商品接收人员ID
     * @param receiveUserId 在途商品接收人员ID
     */
    ...
    /**
     * 在途商品接收人员名称
     * @return receiveUserName 在途商品接收人员名称
     */
    ...
    /**
     * 在途商品接收人员名称
     * @param receiveUserName 在途商品接收人员名称
     */
    ...
    /**
     * 成品标记：0旧料；1：成品
     * @return chengPinFlag 成品标记：0旧料；1：成品
     */
    public Boolean getChengPinFlag() {
        return chengPinFlag;
    }

    /**
     * 成品标记：0旧料；1：成品
     * @param chengPinFlag 成品标记：0旧料；1：成品
     */
    public void setChengPinFlag(Boolean chengPinFlag) {
        this.chengPinFlag = chengPinFlag;
    }
    /**
     * 标签文件
     * @return grfName 标签文件
