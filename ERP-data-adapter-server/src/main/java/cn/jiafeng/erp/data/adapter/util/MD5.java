...
package cn.jiafeng.erp.data.adapter.util;
...
public class MD5
{
    ...
    public String getMD5Encode(String s)
    {
        // 两次加密
        return getMD5ofStr(getMD5ofStr(s));
    }
    ...
    {
        // 測試 123123=4297F44B13955235245B2497399D7A93
        // admin=21232F297A57A5A743894A0E4A801FC3
        MD5 md5 = new MD5();
        String aa = md5.getMD5ofStr("1");
        System.out.println(aa);

        aa = md5.getMD5ofStr(aa);
        System.out.println(aa);
    }
